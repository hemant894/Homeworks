...
public class javaArchitecture {public static void main(String[] args) { System.out.println(" JVM (Java Virtual Machine) is an abstract machine. it is a specification that provides runtime environment in which java bytecode can be excuted.");
    System.out.println(" JRE (Java Runtime Environment) is a runtime environment which implements JVM and provides all class libraries and other files that JVM uses at runtime.");
    System.out.println(" JDK (Java Development kit ) is the tool necessary to compile, document and package java programs. The JDK completely includes JRE.");
